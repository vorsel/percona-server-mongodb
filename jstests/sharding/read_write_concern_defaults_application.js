...
let testCases = {
    ...
    _shardsvrReshardDonorRecipientsFinishedCloning: {skip: "internal command"},
    ...
    eseRotateActiveKEK: {skip: "does not accept read or write concern"},
    ...
    blockReplicaSetWrites: {skip: "does not accept read or write concern"},
