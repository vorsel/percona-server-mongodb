...
Instead of building Percona Server for MongoDB from source, you can [download](https://www.percona.com/downloads/percona-server-mongodb-4.4/) and use binary tarballs. Follow the [installation instructions](https://www.percona.com/doc/percona-server-for-mongodb/4.4/install/tarball.html) in our documentation.
