...
Instead of building Percona Server for MongoDB from source, you can [download](https://www.percona.com/downloads/percona-server-mongodb-4.0/) and use binary tarballs. Follow the [installation instructions](https://www.percona.com/doc/percona-server-for-mongodb/4.0/install/tarball.html) in our documentation.
...
4. Define Percona Server for MongoDB version (4.0.23 for the time of writing this document)
```sh
