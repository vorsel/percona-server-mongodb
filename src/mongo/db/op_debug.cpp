...
void OpDebug::report(OperationContext* opCtx,
    ...
    OPDEBUG_TOATTR_HELP_BOOL_NAMED("failedPlanningWithQuerySettings",
                                   failedPlanningWithQuerySettings);
...
std::function<BSONObj(OpDebug::AppendArgs)> OpDebug::appendStaged(OperationContext* opCtx,
    ...
    addIfNeeded("rateLimit", [](auto field, auto args, auto& b) {
        b.append(field,
                 durationCount<Milliseconds>(args.op.getAdditiveMetrics().executionTime.value_or(
